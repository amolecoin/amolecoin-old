...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/AmoleCoin/AmoleCoin-Core>";
    const std::string URL_WEBSITE = "<https://www.amolecoin.org>";
