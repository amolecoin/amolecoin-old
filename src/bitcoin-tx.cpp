...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s amolecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  amolecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded amolecoin transaction") + "\n" +
              "  amolecoin-tx [options] -create [commands]   " + _("Create hex-encoded amolecoin transaction") + "\n" +
              "\n";
